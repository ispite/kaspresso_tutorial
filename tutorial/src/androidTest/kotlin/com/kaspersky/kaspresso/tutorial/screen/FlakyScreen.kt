...
object FlakyScreen : KScreen<FlakyScreen>() {
    ...
    val text1 = KTextView { withId(R.id.text_1) }
    val text2 = KTextView { withId(R.id.text_2) }
    val text3 = KTextView { withId(R.id.text_3) }
    val text4 = KTextView { withId(R.id.text_4) }
    val text5 = KTextView { withId(R.id.text_5) }
